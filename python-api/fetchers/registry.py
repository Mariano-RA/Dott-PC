...
# Nest es la fuente de verdad: envía solo Proveedores.activo con fetcher.
# Este tuple es capacidad de código (hay fetcher) y fallback si el payload no trae lista.
